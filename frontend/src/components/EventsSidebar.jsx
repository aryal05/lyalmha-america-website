    ...
    <div className="space-y-8 sticky top-24">
      ...
      >
        <h3 className="text-2xl font-bold text-white mb-6 flex items-center">
          <svg
            className="w-6 h-6 mr-2 text-nepal-red"
            fill="none"
            strokeLinecap="round"
        ...
        {loading ? (
          ...
          <div className="space-y-4">
            {upcomingEvents.map((event, index) => (
              ...
              >
                <span className="inline-block px-2 py-1 bg-usa-blue text-white text-xs rounded mb-2 capitalize">
                  {event.event_type}
                </span>
      ...
      >
        <h3 className="text-2xl font-bold text-white mb-6 flex items-center">
          <svg
            className="w-6 h-6 mr-2 text-usa-blue"
            fill="none"
            strokeLinecap="round"
            strokeLinejoin="round"
            strokeWidth="2"
        ...
        {loading ? (
          ...
          <p className="text-gray-400 text-center py-4">No past events</p>
        )}
