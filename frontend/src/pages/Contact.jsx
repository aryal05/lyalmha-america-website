...
import heroBg from '../assets/images/posts/462650425_598936739649734_2260957587124948845_n.jpg'
            ...
            >
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <a href="mailto:info@lyalmha-america.org" className="text-gray-400 hover:text-nepal-red transition-colors duration-300">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <a href="tel:+15551234567" className="text-gray-400 hover:text-nepal-red transition-colors duration-300">
                        +1 (555) 123-4567
                      </a>
                    </div>
                  </div>
              ...
              <div className="bg-accent-gray rounded-xl p-6">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="w-12 h-12 bg-usa-blue rounded-full flex items-center justify-center hover:bg-nepal-red transition-colors duration-300">
              ...
              <div className="bg-gradient-to-br from-nepal-red to-usa-blue rounded-xl p-6 text-center">
                ...
                <p className="text-white/90 text-sm mb-4">
                  Become a part of our mission to preserve and celebrate Newari culture
                </p>
                <Link to="/about" className="inline-block px-6 py-3 bg-white text-nepal-red font-semibold rounded-lg hover:bg-gray-100 transform hover:scale-105 transition-all duration-300">
                  Learn More
                </Link>
              </div>
            </motion.div>
