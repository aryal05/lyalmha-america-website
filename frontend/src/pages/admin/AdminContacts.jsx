      ...
      <div className="relative">
        ...
        >
          ...
          <div className="px-6 py-3 bg-gradient-to-r from-gold-accent to-newari-red text-white rounded-xl shadow-lg">
            <p className="text-sm font-medium opacity-90">Total Messages</p>
        ...
        <div className="flex gap-3 mb-6">
          <button
            ...
            className={`px-6 py-2.5 rounded-lg font-semibold transition-all shadow-md ${
              filter === "all"
                ? "bg-gradient-to-r from-gold-accent to-newari-red text-white shadow-lg"
                : "bg-white text-gray-700 hover:bg-gray-50 border-2 border-gray-200 hover:border-royal-blue"
            }`}
          >
            All ({messages.length})
          </button>
        ...
        {loading ? (
          <div className="text-center py-12">
            <div className="animate-spin rounded-full h-12 w-12 border-4 border-royal-blue border-t-transparent mx-auto"></div>
                  ...
                  className={`p-5 rounded-xl border-2 cursor-pointer transition-all shadow-md hover:shadow-xl ${
                    selectedMessage?.id === message.id
                      ...
                      : message.status === "unread"
                        ? "border-newari-red/40 bg-red-50/30"
                        : "border-gray-200 bg-white hover:border-royal-blue"
                  }`}
                  onClick={() => {
