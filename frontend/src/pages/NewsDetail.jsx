        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <span className="px-4 py-2 bg-gradient-to-r from-gold-accent to-newari-red text-white text-sm font-semibold rounded-full">
              {newsItem.category.split('-').map(word => word.charAt(0).toUpperCase() + word.slice(1)).join(' ')}
            </span>
          ...
          {newsItem.author && newsItem.author.toLowerCase() !== 'admin' && (
            ...
            >
              ...
              <div>
                <p className="font-semibold text-primary-text">{newsItem.author}</p>
          ...
          {newsItem.tags && (
            ...
            >
              <h3 className="text-sm font-semibold text-paragraph-text mb-3">Tags:</h3>
          ...
          <motion.div
            ...
            className="mt-12 pt-8 border-t border-border-line"
          >
            <h3 className="text-lg font-semibold text-primary-text mb-4">Share this article</h3>
