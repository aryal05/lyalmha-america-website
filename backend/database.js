...
export async function initializeDatabase() {
  ...
  // Check if using Supabase (PostgreSQL)
  ...
  // Create tables (SQLite schema - PostgreSQL should be created separately)
  if (!isPostgres) {
    await db.exec(`
...
export default { initializeDatabase, getDatabase, isPostgresDB }
