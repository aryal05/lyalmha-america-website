...
async function seedBiskaJatraProject() {
  ...
  const fullDescription = `
    <div class="space-y-6">
      ...
      <p>Our coordinating committee members and volunteers worked tirelessly to build a Replica of a <strong class="text-gold-accent">Dyou-Kha</strong> (an auspicious chariot of the Gods and Goddesses) and a Chhatra. The Biskaa Jatra Dyou-Kha symbolizes the newari Civilization prior to the invention of wheels in human history. This Dyou-Kha is carried on human shoulders.</p>
